                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <ul className="nav nav-tabs" id="myTab" role="tablist" style={{ display: "flex", justifyContent: "center", border: "none" }}>
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link" id="main-tab" data-bs-toggle="tab" data-bs-target="#main-tab-pane" type="button" role="tab" aria-controls="main-tab-pane" aria-selected="false" >All</button>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="tab-content pt-4" id="myTabContent">
                                    ...
                                    <div className="tab-pane fade" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex="0">
                                        <div className="row">
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="1_VRRjpA33vudDWtyRpxwdmA.gif" alt='game' />
                                                    <div className="pro-overlay">
                                                        <h3>Tic Toy Game</h3>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="hug wall.gif" alt='game2' />
                                                    <div className="pro-overlay">
                                                        <h3>Snake Game</h3>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="gujarati-letter-bubble-pop-game.gif" alt='game3' />
                                                    <div className="pro-overlay">
                                                        <h3>Bubble Game</h3>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="0264bcd1627ee2a35fb39aa18cdad77d.gif" alt='game4' />
                                                    <div className="pro-overlay">
                                    ...
                                    <div className="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabIndex="0">
                                        <div className="row">
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="date.gif" alt='calculate' />
                                                    <div className="pro-overlay">
                                                        <h3>Age Calculator App</h3>
                                                        <p></p>
                                                        <a href="https://rupali123r.github.io/AgeCalculator/" rel="noreferrer" target="_blank">View Code</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="image_processing20200502-14719-1o0yic3.png" alt='app' />
                                                    <div className="pro-overlay">
                                                        <h3>Calculator App</h3>
                                                        <p></p>
                                                        <a href="https://rupali123r.github.io/javascript_calculator/" rel="noreferrer" target="_blank">View Code</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="dating-app-chat-interface-template-set_23-2148530299.jpg" alt='cah4' />
                                                    <div className="pro-overlay">
                                                        <h3>Chat App</h3>
                                                        <p>Dating Chat App Design</p>
                                                        <a href="https://rupali123r.github.io/Chat_Box_Using_JavaScript/" rel="noreferrer" target="_blank">view code </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-md-6 p-0 ">
                                                <div className="project">
                                                    <img src="4lx9jf.gif" alt='meme' />
                                                    <div className="pro-overlay">
                                                        <h3>Meme Generator App</h3>
                                                        <p>Random Meme Generator App</p>
                                                        <a href="https://rupali123r.github.io/JavaScript_Random_meme_generate_using_api/" rel="noreferrer" target="_blank">view Code</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="multiple-option-quiz-game-template-problem-solving-concept_1017-45303.avif" alt='quiz' />
                                                    <div className="pro-overlay">
                                                        <h3>Quiz question App</h3>
                                                        <p></p>
                                                        <a href="https://rupali123r.github.io/JavaScript-quiz_Question_App/" rel="noreferrer" target="_blank">view Code </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="f6a5a5a29eab0f0e245d30470b672855.gif" alt='recipe' />
                                                    <div className="pro-overlay">
                                                        <h3>Recipe App</h3>
                                                        <p></p>
                                                        <a href="https://rupali123r.github.io/JavaScript_Recipe_App_Using_api/" rel="noreferrer" target="_blank">Live </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-3 col-md-6 p-0">
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="screen-shot-2023-01-10-at-11-40-04-am.webp" alt='insta' />
                                                    <div className="pro-overlay">
                                                        <h3>InstaGram Stroy App</h3>
                                                        <p></p>
                                                        <a href="https://rupali123r.github.io/Insta_Effects_project/" rel="noreferrer" target="_blank">view code </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="tab-pane fade" id="main-tab-pane" role="tabpanel" aria-labelledby="main-tab" tabIndex="0">

                                        <div className="row">
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="ff033dc39574f5dfae4c91a5605f1120.gif" alt='to od' />
                                                    <div className="pro-overlay">
                                                        <h3>To do List App</h3>
                                                        <p></p>
                                                        <a href="/" rel="noreferrer" target="_blank">view code </a>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0 ">
                                                <div className="project">
                                                    <img src="4lx9jf.gif" alt='typing' />
                                                    <div className="pro-overlay">
                                                        <h3>Typing master App</h3>
                                                        <p> Typing Master App</p>
                                                        <a href="https://rupali123r.github.io/Typing-master-App/" rel="noreferrer" target="_blank">view Code</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="free-images-for-commercial-use--15-.png" alt='bhopal' />
                                                    <div className="pro-overlay">
                                                        <h3>Bhopal.city</h3>
                                                        <p>Serching Website</p>
                                                        <a href="https://bhopal.city/" rel="noreferrer" target="_blank">Live </a>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="dating-app-chat-interface-template-set_23-2148530299.jpg" alt='chat' />
                                                    <div className="pro-overlay">
                                                        <h3>Chat App</h3>
                                                        <p>Dating Chat App Design</p>
                                                        <a href="https://rupali123r.github.io/Chat_Box_Using_JavaScript/" rel="noreferrer" target="_blank">view code </a>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="hug wall.gif" alt='snake' />
                                                    <div className="pro-overlay">
                                                        <h3>Snake Game</h3>
                                                        <a href="https://rupali123r.github.io/Snake_game/">Play</a>
                                                    </div>
                                            ...
                                            <div className="col-lg-3 col-md-6 p-0">
                                                <div className="project">
                                                    <img src="0264bcd1627ee2a35fb39aa18cdad77d.gif" alt='dragen' />
                                                    <div className="pro-overlay">
                                                        <h3>Dragan War Game</h3>
                                                        <a href="https://rupali123r.github.io/dragan_game/">Play</a>
                                                    </div>
